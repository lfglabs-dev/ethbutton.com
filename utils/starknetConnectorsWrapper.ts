...
export const getConnectors = (): any[] => {
  const connectors = [
...
export const getLastConnector = (): Connector | null => {
  if (localStorage.getItem("ETH-button-lastUsedConnector")) {
    const connectordId = localStorage.getItem("ETH-button-lastUsedConnector");
...
export const getLastConnected = (): Connector | null => {
  if (localStorage.getItem("ETH-button-connectedWallet")) {
    const connectordId = localStorage.getItem("ETH-button-connectedWallet");
    const connector = getConnectors().find((item) => item.id === connectordId);
    return connector || null;
  }
  return null;
...
export const getArgentIcon = (): string => {
  return wallets.find((wallet) => wallet.id === "argentX")?.icon as string;
};

export const getArgentWebsite = (): string => {
  return wallets.find((wallet) => wallet.id === "argentX")?.website as string;
};

export const getBraavosIcon = (): string => {
  return wallets.find((wallet) => wallet.id === "braavos")?.icon as string;
};
